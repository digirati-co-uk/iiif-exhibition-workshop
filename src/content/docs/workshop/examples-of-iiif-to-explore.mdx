---
title: Activity 1 - Examples of IIIF to Explore
...
Using the IIIF Manifest Editor provides users with the ability to import an existing manifest and then edit it within the platform, allowing them to develop and enhance their existing IIIF as required. This feature also enables users to browse published IIIF Collections and Manifests and examine those - perhaps to inform how to structure aspects of the metadata, or see how specific IIIF Presentation specification features have been used by other institutions.
...
The Medieval Manuscript Collection we created for today's workshop can be accessed from:
...
- https://damsssl.llgc.org.uk/iiif/2.0/6218786/manifest.json [🖼️](https://theseusviewer.org?iiif-content=https://damsssl.llgc.org.uk/iiif/2.0/6218786/manifest.json)
- https://damsssl.llgc.org.uk/iiif/2.0/1131490/manifest.json [🖼️](https://theseusviewer.org?iiif-content=https://damsssl.llgc.org.uk/iiif/2.0/1131490/manifest.json)

### University of Edinburgh

- https://librarylabs.ed.ac.uk/iiif/manifest/calendars/2016:_Cities_of_the_World.json [🖼️](https://theseusviewer.org?iiif-content=https://librarylabs.ed.ac.uk/iiif/manifest/calendars/2016:_Cities_of_the_World.json)

### National Library of Scotland

:::warning
National Library of Scotland are having some technical issues with their IIIF Image API.
:::

...
description: Learn how to create new IIIF Manifests from scratch using the IIIF Publishing area, add images as canvases, and edit manifests with the Manifest Editor to create rich digital presentations.
---
...
![Create a new manifest](https://digirati-workshop-iiif-2025.pages.dev/create-manifest-step1.PNG)
...
![Manifest portal view](https://digirati-workshop-iiif-2025.pages.dev/create-manifest-step2.PNG)
...
![Navigate to your spaces](https://digirati-workshop-iiif-2025.pages.dev/create-manifest-step3.PNG)
...
![Basic manifest edit](https://digirati-workshop-iiif-2025.pages.dev/edit-manifest-step1.PNG)
...
![Opening the manifest in ME](https://digirati-workshop-iiif-2025.pages.dev/edit-manifest-step2.PNG)
...
![Edit canvas in ME](https://digirati-workshop-iiif-2025.pages.dev/edit-manifest-step3.PNG)
...
![Edit canvas label in ME](https://digirati-workshop-iiif-2025.pages.dev/edit-manifest-step4.PNG)
...
![Add required statement in ME](https://digirati-workshop-iiif-2025.pages.dev/edit-manifest-step6.PNG)

Label could be “Attribution”, and Value something relevant to the image(s) you are adding to Manifest.

![Required statement in ME](https://digirati-workshop-iiif-2025.pages.dev/edit-manifest-step7.PNG)

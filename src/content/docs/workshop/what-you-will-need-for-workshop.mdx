...
We will use this tool today to enable inspection and exploration of existing IIIF content and to support you in the creation of your own IIIF content. You can browse the user guide documentation which we'll reference today at any time - seeing [Getting started](https://manifest-editor-docs.netlify.app/docs/getting-started).

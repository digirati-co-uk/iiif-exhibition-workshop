---
title: What You'll Need for the Online Workshop
...
In this brief hands-on online workshop we will help you start to get familiar with IIIF, providing you with the initial insights required when considering it for your work  be that research, education or simply exploration of digitised materials.
...
### IIIF Manifest Editor and Exhibition Viewer
...
We will use this tool today to enable inspection and exploration of existing IIIF content and to support you in the creation of your own IIIF content, before we then use the Exhibition building features of the editor to develop your exhibition content. You can browse the user guide documentation which we'll reference today at any time - seeing [Getting started](https://manifest-editor-docs.netlify.app/docs/getting-started).

The Exhibition Viewer, is a IIIF viewer that has developed out of a collaboration between TU Delft and Digirati. This flexible, open source viewer enables the display of engaging, interactive online exhibitions either as a standalone wensite, or embedded in differing ways in an existing website. We will demonstrate how this can be used and during our activities we will use this to view the example exhibitions that are built today. More information can be viewed on the supporting [Exhibition Viewer](https://exhibitionviewer.org/) website.

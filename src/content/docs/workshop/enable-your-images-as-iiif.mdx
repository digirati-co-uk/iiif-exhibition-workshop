---
title: Enable Your Images as IIIF
description: Learn how to upload images to the IIIF Cloud Service portal, make them available as IIIF Images with deep zoom capabilities, and explore the power of the IIIF Image API.
---

import { PyramidEmbed } from "@/components/PyramidEmbed";

# Uploading images to your IIIF CS portal workshop environment
...
![Spaces overview](https://digirati-workshop-iiif-2025.pages.dev/spaces-overview-example.PNG)

Click to add a New space, and you can name it ‘Workshop examples’ or perhaps something relevant to the type of image you plan to upload.

![Spaces adding new folder](https://digirati-workshop-iiif-2025.pages.dev/spaces-new-folder-example.PNG)
...
![Spaces - adding images](https://digirati-workshop-iiif-2025.pages.dev/spaces-add-image-step-one.PNG)
...
![Spaces - file upload images](https://digirati-workshop-iiif-2025.pages.dev/spaces-add-image-step-two.PNG)
...
![Spaces - file upload metadata](https://digirati-workshop-iiif-2025.pages.dev/spaces-add-image-step-three.PNG)
...
![Spaces - files uploaded](https://digirati-workshop-iiif-2025.pages.dev/spaces-add-image-step-four.PNG)
...
![IIIF Image metadata](https://digirati-workshop-iiif-2025.pages.dev/image-inspect-iiif-metadata-details.PNG)
...
![IIIF Image thumbnail](https://digirati-workshop-iiif-2025.pages.dev/image-inspect-iiif-metadata-details-thumbnail-size.png)
...
![IIIF Image - gray 180 version](https://digirati-workshop-iiif-2025.pages.dev/inspecting-iiif-enabled-image-gray-180.PNG)

## Taking the IIIF Image API further

:::note
We won't go into detail in the workshop on this area; but you can experiment further to explore how the IIIF enabled image supports deep zoom and how these images can be presented on your website without leveraging the IIIF Presentation API.
:::

It's worth highlighting the power of image deep-zoom and visualising this. Using the pyramid demo below that was created recently by Jules Schoonman at TU Delft, you can see how viewers navigate you through the IIIF tile pyramid: https://observablehq.com/@allmaps/tile-pyramid
...
![IIIF Image examine endpoint](https://digirati-workshop-iiif-2025.pages.dev/image-inspect-iiif-api-endpoint.PNG)
...
![Theseus - examine image](https://digirati-workshop-iiif-2025.pages.dev/accessing-iiif-enabled-image-via-theseus.PNG)

Clicking on 'View Manifest' should load the manifest into the Theseus viewer where you can browse the IIIF enabled image:

![Theseus - examine image](https://digirati-workshop-iiif-2025.pages.dev/image-inspect-iiif-api-endpoint-with-theseus2.PNG)
